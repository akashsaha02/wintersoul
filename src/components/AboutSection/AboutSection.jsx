...
const AboutSection = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 bg-green-100 shadow-lg rounded-lg overflow-hidden my-6 items-center">
                <img
                    src={aboutImg}
                    alt="About Us"
                ...
                <div className="p-8 text-center md:text-start">
                    <h2 className="text-2xl md:text-3xl font-bold text-indigo-800 mb-4">About Us</h2>
